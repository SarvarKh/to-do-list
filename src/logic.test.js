...
describe('Projects manipulation', () => {
  ...
  test('Delete old projects from HTML page', () => {
...
describe('Task creation', () => {
  ...
  test('Create Task object', () => {
    expect(new Task('testing_title', 'testing_description', 'testing_dueDate', 'testing_priority', 'testing_notes', 'testing_checklist')).toEqual({
      title: 'testing_title', description: 'testing_description', dueDate: 'testing_dueDate', priority: 'testing_priority', notes: 'testing_notes', checklist: 'testing_checklist',
    });
  });
});
...
describe('Task manipulation', () => {
  ...
  test('Delete old tasks from HTML page', () => {
